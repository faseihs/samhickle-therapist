            ...
            <div style="display: none;" class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text"  name="post_code" value="{{$profile->location_name}}" class="form-control" placeholder="Your Post Code">
                        <input style="display: none;" type="text" id="postCode" name="postal_code" value="{{$profile->postal_code}}" class="form-control" placeholder="Your Post Code">
...
@section('scripts')
    ...
    <script src="/js/edit-profile.js?v=7"></script>
    <style>
        .pac-container:after {
