    ...
    'connections' => [
        ...
        */
        'square' => [
            ...
            'application_id' => env('APP_ENV')=='local'?env('SQUARE_SANDBOX_ID'):env('SQUAUE_APPLICATION_ID'),
            'access_token'   => env('APP_ENV')=='local'?env('SQUARE_SANDBOX_ACCESS_TOKEN'):env('SQAURE_APPLICATION_TOKEN'),
